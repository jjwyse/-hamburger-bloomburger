...
const properties = {
  githubClientId: process.env.BLOOMBURGER_GITHUB_CLIENT_ID,
  githubClientSecret: process.env.BLOOMBURGER_GITHUB_CLIENT_SECRET,
  redirectUri: process.env.BLOOMBURGER_REDIRECT_URL,
};
